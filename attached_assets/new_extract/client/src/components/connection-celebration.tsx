...
import { Heart, Users, Plane, MapPin, Sparkles, Check, X } from 'lucide-react';
      ...
      {isVisible && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md mx-4 text-center shadow-2xl relative"
