    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-800 dark:to-orange-900">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-white" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>
            Nearby Traveler for Businesses
          </h1>
          <p className="text-xl lg:text-2xl max-w-3xl mx-auto mb-8 text-white" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8)'}}>
            Connect with travelers and locals who are actively exploring your area and looking for authentic experiences
          </p>
          <a
            href="/business-registration"
            className="inline-block px-8 py-4 bg-gradient-to-r from-blue-500 to-orange-400 font-bold rounded-lg shadow-xl hover:scale-105 transition text-lg text-black"
          >
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="mt-16 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">Perfect for All Types of Businesses</h2>
