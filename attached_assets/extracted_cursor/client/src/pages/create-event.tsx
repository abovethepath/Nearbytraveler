...
// Extended form type to include separate time fields and full address
...
export default function CreateEvent({ onEventCreated }: CreateEventProps) {
  ...
  const createEventMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      // Invalidate both city-specific and all events queries
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (data.date && data.startTime) {
        startDateTime = new Date(`${data.date}T${data.startTime}`);
      } else if (data.date) {
      ...
      const displayLocation = `${data.street}, ${data.city}, ${data.state} ${data.zipcode}, ${data.country}`;
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <SmartLocationInput
                  ...
                  onLocationChange={(location) => {
                    ...
                    setValue("location", `${location.city}${location.state ? `, ${location.state}` : ""}, ${location.country}`);
                  }}
                  required={true}
                  placeholder={{
              ...
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  if (value !== "Custom") {
                    ...
                    setCustomCategory(""); // Clear custom category when selecting predefined
                  }
                }}
              >
            ...
            <div className="pt-4">
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-500 to-gray-600 hover:from-blue-600 hover:to-gray-700 text-white font-semibold py-3"
              >
