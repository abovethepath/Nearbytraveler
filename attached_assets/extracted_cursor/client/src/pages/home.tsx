...
export default function Home() {
  ...
  const events = useMemo(() => {
    ...
    console.log('Filtered events:', upcomingEvents.length, 'upcoming events from ALL locations');
  ...
  // Prioritize users by hometown first, then travel destinations
  const prioritizeUsers = (users: User[]) => {
    if (!effectiveUser?.hometownCity && !travelPlans?.length) return users;
    ...
    return users.sort((a, b) => {
      // Priority 1: Users from same hometown
      ...
      // Priority 2: Users traveling to my destinations
  ...
  const filteredUsers = prioritizeUsers(usersToFilter).filter(otherUser => {
    ...
    if (filters.location && filters.location.trim() !== "") {
      ...
      const metroAreas: Record<string, string[]> = {
        ...
        "chicago": ["chicago", "evanston", "naperville", "aurora", "joliet", "waukegan"],
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-xl xs:text-2xl sm:text-4xl lg:text-6xl font-bold mb-6 leading-tight text-white text-center" style={{fontFamily: '"Open Sans", sans-serif', fontWeight: '700', textShadow: '1px 1px 0 black, -1px 1px 0 black, 1px -1px 0 black, -1px -1px 0 black, 0 1px 0 black, 0 -1px 0 black, 1px 0 0 black, -1px 0 0 black'}}>
            ...
            {effectiveUser?.userType === 'business' ? (
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-blue-600 to-orange-500 hover:from-blue-700 hover:to-orange-600 text-black px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg btn-bounce w-full sm:w-[200px] shadow-lg border border-blue-500"
                ...
                <Button 
                  size="lg"
                  className="bg-gradient-to-r from-green-600 to-blue-500 hover:from-green-700 hover:to-blue-600 text-black px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg btn-bounce w-full sm:w-[200px] shadow-lg border border-green-500"
                  onClick={() => {
      ...
      <main className="pt-4 pb-20 lg:pb-4">
        ...
        {/* Quick Filters with modern styling - Mobile optimized with only Advanced Search */}
        <section className="mb-8">
          <div className="p-4 sm:p-6">
            ...
            {/* Advanced Filters Toggle - Only button for mobile */}
            <Button
              variant="outline"
              size="sm"
              onClick={() => setShowAdvancedFilters(!showAdvancedFilters)}
              className="ml-2 bg-gradient-to-r from-blue-500 to-orange-500 text-white hover:from-blue-600 hover:to-orange-600 transition-all duration-300 rounded-xl hover:scale-105 border-0"
            >
              <Filter className="w-4 h-4 mr-2" />
              Advanced Search
              <ChevronDown className={`w-4 h-4 ml-2 transform transition-transform duration-300 ${showAdvancedFilters ? 'rotate-180' : ''}`} />
            </Button>
          </div>
          </div>
          ...
          <Collapsible open={showAdvancedFilters} onOpenChange={setShowAdvancedFilters}>
            <CollapsibleContent className="mt-4" ref={filtersRef}>
              <Card className="p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      onClick={() => {
                        setShowAdvancedFilters(false);
                        // Scroll to discover people section
                        setTimeout(() => {
                ...
                <div className="flex gap-4 mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="w-36">
                      ...
                      <div className="space-y-0.5 border border-gray-200 dark:border-gray-600 rounded-md px-2 py-1 bg-white dark:bg-gray-700">
                        {GENDER_OPTIONS.map((gender) => (
                          <div key={gender} className="flex items-center space-x-2">
                            ...
                            />
                            <label htmlFor={`gender-${gender}`} className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                              {gender}
                            </label>
                          </div>
                        ))}
                    ...
                    <div className="w-40">
                      <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">Sexual Preference</label>
                      <div className="space-y-0.5 border border-gray-200 dark:border-gray-600 rounded-md px-2 py-1 bg-white dark:bg-gray-700">
                        {SEXUAL_PREFERENCE_OPTIONS.map((preference) => (
                          <div key={preference} className="flex items-center space-x-2">
                            <input
                              type="checkbox"
                              id={`pref-${preference}`}
                              checked={filters.sexualPreference.includes(preference)}
                              onChange={(e) => {
                                if (e.target.checked) {
                              ...
                              className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 dark:border-gray-500 rounded bg-white dark:bg-gray-600"
                            />
                            <label htmlFor={`pref-${preference}`} className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                              {preference}
                            </label>
                          </div>
                        ))}
                  ...
                  <div className="flex flex-col gap-2">
                    {/* User Type Filter */}
                    <div className="w-32">
                      <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">User Type</label>
                      <div className="space-y-0.5 border border-gray-200 dark:border-gray-600 rounded-md px-2 py-1 bg-white dark:bg-gray-700">
                        {USER_TYPE_OPTIONS.map((type) => (
                          <div key={type} className="flex items-center space-x-2">
                            <input
                              ...
                              className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 dark:border-gray-500 rounded bg-white dark:bg-gray-600"
                            />
                            <label htmlFor={`usertype-${type}`} className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer capitalize">
                              {type}
                            </label>
                          </div>
                        ))}
                    ...
                    <div className="w-32">
                      ...
                      <div className="space-y-1">
                        <Input 
                          ...
                          className="w-full text-sm px-2 py-1 bg-white dark:bg-gray-800 border-gray```python
-200 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400"
                        />
                        <Input 
                          type="number" 
                          placeholder="Max"
                          ...
                          className="w-full text-sm px-2 py-1 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex-1">
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">Traveler Type</label>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-white dark:bg-gray-700">
                      {BASE_TRAVELER_TYPES.map((type) => (
                        <div key={type} className="flex items-center space-x-2">
                          <input
                            ...
                            className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 dark:border-gray-500 rounded bg-white dark:bg-gray-600"
                          />
                          <label htmlFor={`traveler-type-${type}`} className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                            {type}
                          </label>
                        </div>
                      ))}
                ...
                <div className="mt-4">
                  <div className="bg-gradient-to-r from-blue-100 to-orange-100 dark:from-blue-900/30 dark:to-orange-900/30 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
                    <h3 className="text-sm font-bold text-black dark:text-white mb-3">Top Choices for Most Locals and Travelers</h3>
                    <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2">
                      {["Single and Looking", "Coffee Culture", "Nightlife & Dancing", "Photography", "Meet Locals/Travelers", "Craft Beer & Breweries", "Local Food Specialties", "Hiking & Nature", "City Tours & Sightseeing", "Street Art", "Cocktails & Bars", "Adventure Tours", "Food Tours / Trucks", "Museums", "Rooftop Bars", "Local Hidden Gems", "Beach Activities", "Fine Dining", "Yoga & Wellness", "Pub Crawls & Bar Tours", "Walking Tours", "Happy Hour Deals", "Boat & Water Tours", "Brunch Spots", "Live Music Venues", "Historical Tours", "Festivals & Events", "Casinos", "Architecture"].map((choice) => (
                        <button
                          key={choice}
                          onClick={() => {
                          ...
                          className={`px-3 py-2 text-xs rounded-full border transition-all ${
                            filters.interests.includes(choice)
                              ? 'bg-gradient-to-r from-blue-500 to-orange-500 text-white border-blue-500'
                ...
                <div className="mt-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 border border-gray-200 dark:border-gray-600 rounded-lg p-3 bg-blue-50 dark:bg-blue-900/20 mb-2">
                    {getAllInterests().map((interest) => {
                      const displayText = interest.startsWith("**") && interest.endsWith("**") ? 
                        interest.slice(2, -2) : interest;
                      // Only bold Veteran and I am a Veteran, not Single and Looking
                      const isBold = interest.startsWith("**") && interest.endsWith("**") && 
                        (interest === "**Veteran**" || interest === "**I am a Veteran**");
                      ...
                      return (
                        <div key={interest} className="flex items-center space-x-2">
                          ...
                          <label 
                            ...
                            className={`text-sm text-gray-700 dark:text-gray-300 cursor-pointer leading-tight ${isBold ? 'font-bold' : 'font-medium'}`}
                          >
                            {displayText}
                          </label>
                        </div>
                ...
                {/* Activities Filter */}
                <div className="mt-4">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">Activities</label>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 border border-gray-200 dark:border-gray-600 rounded-lg p-3 bg-white dark:bg-gray-700 mb-2">
                    {getAllActivities().map((activity, index) => (
                      <div key={`filter-activity-${activity}-${index}`} className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                        ...
                        <label 
                          ...
                          className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer leading-tight font-medium"
                        >
                          {activity}
                        </label>
                      </div>
                ...
                {/* Events Filter */}
                <div className="mt-4">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">Events</label>
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 border border-gray-200 dark:border-gray-600 rounded-lg p-3 bg-white dark:bg-gray-700 mb-2">
                    {getAllEvents().map((eventType) => (
                      <div key={eventType} className="flex items-center space-x-2">
                        <input
                          ...
                          checked={filters.events.includes(eventType)}
                          onChange={(e) => {
                            if (e.target.checked) {
                ...
                <div className="mt-4">
                  <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">Military Status</label>
                  <div className="grid grid-cols-2 gap-3 border border-gray-200 dark:border-gray-600 rounded-lg p-3 bg-white dark:bg-gray-700">
                    {[
                      ...
                      <div key={status.value} className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          id={`filter-military-${status.value}`}
                          checked={filters.militaryStatus.includes(status.value)}
                          onChange={(e) => {
                            if (e.target.checked) {
                          ...
                          className={`h-4 w-4 text-${status.color}-600 focus:ring-${status.color}-500 border-gray-300 dark:border-gray-500 rounded bg-white dark:bg-gray-600`}
                        />
                        <label 
                          htmlFor={`filter-military-${status.value}`} 
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-2 space-y-8 min-w-0">
            ...
            {(usersLoading || (activeFilter === "best-matches" && matchedUsersLoading)) ? (
              ...
              <>
                {/* Desktop Grid Layout (hidden on mobile) - Cache Busting v3 */}
                <div className="desktop-grid-layout-v3">
                  {getSortedUsers(filteredUsers).slice(0, displayLimit).map((user) => (
                    <UserCard key={user.id} user={user} />
                  ))}
                </div>

                {/* Mobile Horizontal Scroll Layout (hidden on desktop) - Cache Busting v3 */}
                <div className="md:hidden">
                  <div className="mobile-scroll-layout-v3">
                    {getSortedUsers(filteredUsers).slice(0, displayLimit).map((user) => (
                      <div key={user.id} className="flex-shrink-0 w-64">
                        <div 
                          className="mobile-user-card-v3"
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-1 text-xs text-gray-600 dark:text-gray-400">
                                ...
                                <span className="truncate">
                                  {user.location || (user.hometownCity && user.hometownCountry ? `${user.hometownCity}, ${user.hometownCountry}` : "Location not set")}
                                </span>
                              </div>
                            </div>
                          </div>
                ...
                {/* Load More / Load Less buttons for Users */}
                {getSortedUsers(filteredUsers).length > 6 && (
                  <div className="text-center py-8 space-x-3">
                    {displayLimit < getSortedUsers(filteredUsers).length && (
                      <Button 
                        variant="outline" 
                        className="bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white dark:border-gray-600"
                        onClick={() => setDisplayLimit(Math.min(displayLimit + 9, getSortedUsers(filteredUsers).length))}
                      >
                        Load More ({Math.min(9, getSortedUsers(filteredUsers).length - displayLimit)} more people)
                      </Button>
                    )}
                    {displayLimit > 6 && (
                      <Button
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="bg-gradient-to-r from-purple-500 to-orange-500 text-white hover:from-purple-600 hover:to-orange-600 transition-all duration-300 rounded-xl shadow-lg"
                        ...
                        <div className="space-y-1 text-xs text-gray-500 dark:text-gray-300 flex-1">
                          ...
                          <div className="flex items-center justify-between mt-2">
                            <span className="text-xs text-green-600 font-medium dark:text-green-400">
                              ...
                              {event.participantCount || 1} attending
                            </span>
                            <Button 
                              size="sm" 
            ...
            {/* Quick Meetups Section */}
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-3xl font-bold bg-gradient-to-r from-orange-600 to-red-800 bg-clip-text text-transparent">
                  Quick Meetups Today
                </h2>
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="bg-gradient-to-r from-orange-500 to-red-500 text-white hover:from-orange-600 hover:to-red-600 transition-all duration-300 rounded-xl shadow-lg"
