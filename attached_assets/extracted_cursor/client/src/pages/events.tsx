...
import { Calendar, Clock, MapPin, Users, Search, Filter, Plus, Info, X, Hash } from "lucide-react";
...
export default function Events() {
  ...
  const getCityToQuery = () => {
    ...
    if (selectedLocation.startsWith("destination-")) {
      ...
      const plan = userTravelPlans.find(p => p.id.toString() === planId);
      ...
      <div className="container mx-auto px-2 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-4 mb-6">
          ...
          >
            ...
            <span className="hidden sm:inline">Hashtag Generator</span>
        ...
        {/* Event Hashtags Description - Show on main events page */}
        <div className="max-w-3xl mx-auto mb-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
          <div className="flex items-start gap-3">
            <Hash className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-0.5" />
            <div>
              <h3 className="font-semibold text-purple-900 dark:text-purple-100 mb-2">Event Hashtags Generator</h3>
              <p className="text-sm text-purple-800 dark:text-purple-200">
                Generate relevant hashtags to promote your events on social media platforms like Instagram, Facebook, Twitter, and TikTok. 
                Simply describe your event, and get hashtags that help people discover your event when they search for related topics. 
                Copy the hashtags and paste them into your event posts to increase visibility and attendance.
              </p>
            </div>
          </div>
        </div>
        ...
        {selectedTab === 'hashtags' && (
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Event Hashtag Generator</h2>
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Generate relevant hashtags to promote your events on social media and increase attendance
              </p>
            </div>
            <HashtagRecommender type="event" />
          </div>
        )}
