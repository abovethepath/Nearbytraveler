...
export default function CityPage({ cityName }: CityPageProps) {
  ...
  const getDisplayImage = () => {
    // For Los Angeles, use the known good image
  ...
  // Fetch users for this city using search-by-location endpoint
  const { data: users = [], isLoading: usersLoading } = useQuery({
    queryKey: ['/api/users/search-by-location', decodedCityName],
    queryFn: async () => {
      const response = await fetch(`/api/users/search-by-location?location=${encodeURIComponent(decodedCityName)}&userType=all`);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="px-4 pt-4">
        <button
          ...
          className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-md shadow-sm hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
        >
      ...
      {/* Hero Section */}
      <div className="relative mb-4 rounded-xl overflow-hidden shadow-2xl mx-4 mt-4">
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto">
                      ...
                      <Select value={filter} onValueChange={setFilter}>
                        ...
                        <SelectContent className="bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600">
                          ...
                          <SelectItem value="travelers">Travelers ({users.filter((u: User) => u.userType === 'traveler').length})</SelectItem>
