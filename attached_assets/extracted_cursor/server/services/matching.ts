...
export class TravelMatchingService {
  ...
  private async calculateCompatibilityScore(
    ...
    let totalScore = 0;
    const maxScore = 100; // Reduced max score to increase final percentages: 25 (interests) + 15 (activities) + 10 (events) + 20 (location) + 15 (dates) + 10 (user type) + 5 (travel style)
