...
# How to Meet Locals When Traveling (Not Just Tourists)

You've landed in a new city. Your hotel is fine. The sights are on your list. But the thing that will actually make this trip memorable — the people — is still completely left to chance.
...
Search "[city name] volunteer opportunities" or check Meetup for community service events.
