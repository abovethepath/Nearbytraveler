          ...
          >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-2 text-xs">
                      {fileWithPreview.status === 'pending' && (
                        <span className="text-gray-500 dark:text-gray-400">Ready to upload</span>
                      )}
                      {fileWithPreview.status === 'uploading' && (
            ...
            <div className="flex items-center justify-between pt-4 border-t dark:border-gray-700">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-blue-500 to-orange-500 text-white hover:from-blue-600 hover:to-orange-600 dark:hover:from-blue-600 dark:hover:to-orange-600"
              >
