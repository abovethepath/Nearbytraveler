...
Hope to see you there!`;
                ...
                className="bg-gradient-to-r from-green-500 to-green-400 hover:from-green-600 hover:to-green-500 dark:from-green-500 dark:to-green-600 dark:hover:from-green-600 dark:hover:to-green-700 text-black text-sm"
              >
...
Hope to see you there!`;
                ...
                className="bg-gradient-to-r from-sky-500 to-sky-400 hover:from-sky-600 hover:to-sky-500 dark:from-sky-500 dark:to-blue-600 dark:hover:from-sky-600 dark:hover:to-blue-700 text-black text-sm"
              >
                <svg className="h-4 w-4 mr-2 text-black" fill="currentColor" viewBox="0 0 24 24">
