          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button
                ...
                className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-black text-sm"
              >
              ...
              <Button
                ...
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-black text-sm"
              >
...
Hope to see you there!`;
                ...
                className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-black text-sm"
              >
                <svg className="h-4 w-4 mr-2 text-black" fill="currentColor" viewBox="0 0 24 24">
...
Hope to see you there!`;
                ...
                className="bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-black text-sm"
              >
                <svg className="h-4 w-4 mr-2 text-black" fill="currentColor" viewBox="0 0 24 24">
