    ...
    <div className="w-full relative overflow-hidden rounded-3xl group" data-testid="quick-meetup-widget">
      ...
      {compactOnly && allActiveMeetups.length > 0 && (
        <div className="mb-4 relative">
          ...
          <Card className="relative bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 border-2 border-green-400 dark:border-green-500 shadow-xl">
                ...
                >
                  <CardContent className="p-3 space-y-3 overflow-visible">
                    ...
                    <div className="flex items-center justify-between gap-2 flex-wrap min-w-0">
                      ...
                      <Badge
                        variant="outline"
                        className="text-xs bg-orange-100 dark:bg-orange-500 text-orange-700 dark:text-white border-orange-300 dark:border-orange-500 shrink-0"
                      >
                        <Clock className="w-3 h-3 mr-1 text-orange-700 dark:text-white" />
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <Badge variant="secondary" className="text-[11px] text-gray-700 dark:!text-white dark:[&_*]:!text-white">
                        <Users className="w-3 h-3 mr-1 text-gray-700 dark:!text-white" />
                        {meetup.participantCount} joined
                      </Badge>
                      
                      <div className="text-[10px] text-blue-600 dark:!text-gray-200 font-medium">
                      ...
                      {isOwn ? (
                        <div className={`flex flex-wrap items-center ${!isNativeIOSApp() ? 'gap-1' : 'gap-2'}`}>
                          <Button
                            ...
                            className={`flex-1 sm:flex-initial min-w-0 sm:min-w-[5.5rem] inline-flex items-center justify-center rounded-full
                          ...
                          >
                            <Edit3 className="w-3 h-3 flex-shrink-0 text-green-700 dark:!text-white" />
                            <span>Manage</span>
                          </Button>
                          <Button
                            size="sm"
                          ...
                          >
                            <Trash2 className="w-3 h-3 flex-shrink-0 text-red-700 dark:!text-white" />
                            <span>Cancel</span>
                          </Button>
                        </div>
                      ) : isJoined ? (
