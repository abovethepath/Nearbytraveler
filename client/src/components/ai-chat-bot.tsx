  ...
  return (
    <div className="fixed bottom-6 right-4 w-80 max-w-[calc(100vw-2rem)] h-96 max-h-[80vh] md:w-80 sm:w-72 hidden md:block" style={{ zIndex: 10000 }}>
      <Card className="h-full flex flex-col shadow-xl border-2 bg-white dark:bg-gray-900">
        <CardHeader className="bg-white dark:bg-gray-900 text-black dark:text-white rounded-t-lg py-3 border-b">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-white dark:bg-gray-900">
              ...
              >
                ...
                <div
                  className={`max-w-[240px] rounded-lg px-3 py-2 text-sm ${
                    message.isBot
                      ? "bg-white dark:bg-gray-800 border text-gray-800 dark:text-gray-200"
            ...
            {chatMutation.isPending && (
              <div className="flex gap-2 justify-start">
                ...
                <div className="bg-white dark:bg-gray-800 border rounded-lg px-3 py-2 text-sm text-gray-600 dark:text-gray-400">
