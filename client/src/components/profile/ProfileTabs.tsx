                      ...
                      <HoverCardContent className="w-72 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                        <div className="space-y-2">
                          ...
                          <div className="text-xs space-y-1">
                            ...
                            <div className="flex justify-between"><span className="text-gray-600 dark:text-gray-300">Referring someone who joins</span><span className="font-medium text-orange-600">5 pts</span></div>
                            <div className="flex justify-between"><span className="text-gray-600 dark:text-gray-300">Referred user completes profile</span><span className="font-medium text-orange-600">15 pts</span></div>
                          </div>
                        </div>
                      </HoverCardContent>
                    </HoverCard>
