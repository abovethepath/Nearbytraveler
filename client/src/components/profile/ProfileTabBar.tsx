...
export function ProfileTabBar(props: ProfileTabBarProps) {
  ...
  const badgeClass = isOtherHero
    ? "ml-2 inline-flex items-center justify-center h-[18px] md:h-[20px] lg:h-[22px] min-w-[18px] md:min-w-[20px] lg:min-w-[22px] px-1.5 text-[11px] md:text-[12px] lg:text-xs font-bold rounded-full border border-black/20"
    : (isOwnHero
        ? "ml-1.5 inline-flex items-center justify-center h-[18px] md:h-[20px] lg:h-[22px] min-w-[18px] md:min-w-[20px] lg:min-w-[22px] px-1.5 text-[11px] md:text-[12px] lg:text-xs font-bold rounded-full border border-white/15"
        : (isHero
            ? "ml-2 inline-flex items-center justify-center h-[18px] min-w-[18px] px-1.5 text-[11px] font-bold rounded-full border border-black/20"
            : (isDesktopWeb
                ? "ml-2 inline-flex items-center justify-center h-[18px] min-w-[18px] px-1.5 text-[11px] font-bold rounded-full"
    ...
    <div>
      ...
      {showHint && (
        <p
          style={{
            fontSize: '11px',
            color: isHero ? 'rgba(255,255,255,0.4)' : 'rgba(107,114,128,0.7)',
            fontStyle: 'italic',
            textAlign: 'center',
            marginTop: '6px',
            lineHeight: 1,
