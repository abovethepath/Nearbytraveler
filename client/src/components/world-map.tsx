...
export default function WorldMap({ visitedCountries }: WorldMapProps) {
  ...
  return (
    <div className="w-screen bg-gradient-to-b from-blue-25 to-white py-16 -mx-[50vw] ml-[50%] mt-8 border-t border-gray-200 dark:border-gray-700" style={{background: 'linear-gradient(to bottom, #f8fafc, #ffffff)'}}>
