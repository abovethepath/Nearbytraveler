  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {(showInitialSuggestions || showSearchResults) && (
        <div
          ref={dropdownRef}
          className="absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg max-h-64 overflow-y-auto no-scrollbar"
        >
