      ...
      <CardHeader>
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <span>{data.context.isTraverling ? `✈️ ${(data.context as any).travelDestination || 'Traveling'}` : '🏠 Local'}</span>
          </div>
        </div>
      </CardHeader>
      <CardContent>
              ...
              <CardContent className="p-4 flex-1 flex flex-col">
                ...
                <div className="space-y-1 text-xs text-gray-500 dark:text-gray-300 flex-1">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <Button 
                      size="sm" 
                      className="h-6 px-2 text-xs transition-colors bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 border-0 text-white"
                      onClick={(e) => {
                        e.stopPropagation();
