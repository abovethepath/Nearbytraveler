...
export default function UserCard({ 
  ...
  // Always use computeCommonStats — it applies the same exclusion filters (English, United States,
  // "Welcome to", etc.) as the profile page, so the card count matches the profile badge exactly.
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Connector gold ring overlay */}
        {user.connectorStatus === 'active' && (
            ...
            <div className="!flex !flex-col !items-center !w-full" data-role="user-card-text-container" style={{ textAlign: 'center' }}>
              ...
              >
                ...
                <div className="w-full flex justify-center mt-1">
                  ...
                  >
                    {contactsInCommon} {contactsInCommon === 1 ? 'Mutual Contact' : 'Mutual Contacts'}
                  </span>
                </div>
              </div>
            </div>
