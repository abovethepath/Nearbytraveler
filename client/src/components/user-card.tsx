              ...
              >
                ...
                <div className="w-full flex justify-center mt-1">
                  <span
                    ...
                    className="inline-flex items-center justify-center rounded-full px-3.5 py-1.5 text-[13.5px] font-semibold text-white" style={{ backgroundColor: '#FF6B35' }}
                  >
              ...
              {!isCurrentUser && (
                <>
                  ...
                  <div
                    ...
                    data-role="user-card-contacts"
                  >
                    <span className="inline-flex items-center justify-center rounded-full px-3.5 py-1.5 text-[13.5px] font-semibold text-white" style={{ backgroundColor: '#FF6B35' }}>
                      <span className="lg:hidden">{contactsInCommon} {contactsInCommon === 1 ? 'Mutual Contact' : 'Mutual Contacts'}</span>
                      <span className="hidden lg:inline">{contactsInCommon} {contactsInCommon === 1 ? 'Connection' : 'Connections'} in Common</span>
                    </span>
                  </div>
          ...
          {variant === "homeCity" ? (
            <div className="!flex !flex-col !items-center !w-full !text-center" data-role="user-card-text-container">
              ...
              >
                ...
                >
                  <span className="inline-flex items-center justify-center rounded-full px-3.5 py-1.5 text-[13px] font-semibold text-white" style={{ backgroundColor: '#FF6B35' }}>
                    <span className="lg:hidden">{contactsInCommon} {contactsInCommon === 1 ? 'Mutual Contact' : 'Mutual Contacts'}</span>
                    <span className="hidden lg:inline">{contactsInCommon} {contactsInCommon === 1 ? 'Connection' : 'Connections'} in Common</span>
                  </span>
                </div>
