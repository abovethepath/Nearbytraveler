  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-h-0 h-0 relative">
        ...
        <img src="/logo_transparent.png" alt="" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 600, opacity: 0.12, pointerEvents: 'none', zIndex: 1, background: 'none', border: 'none', boxShadow: 'none', mixBlendMode: 'screen' }} />
