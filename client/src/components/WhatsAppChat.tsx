    ...
    >
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-h-0 h-0">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden overscroll-contain px-3 pt-1 pb-2 bg-[#0f1117] relative" style={{
          ...
          <img src="/logo_transparent.png" alt="" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 600, opacity: 0.12, pointerEvents: 'none', zIndex: 0, background: 'none', border: 'none', boxShadow: 'none', mixBlendMode: 'screen' }} />
