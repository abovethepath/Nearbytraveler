    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <Select value={country} onValueChange={handleCountryChange}>
          ...
          <SelectContent className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 shadow-lg z-[100] max-h-96 overflow-y-auto" container={document.body}>
