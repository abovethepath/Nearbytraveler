...
export function SmartLocationInput({
  ...
  // US/CA lists - popular states first
  const US_STATES = [
    "California", "New York", "Texas", "Florida", "Nevada", "Illinois", "Washington", "Colorado",
    "Massachusetts", "Louisiana", "Tennessee", "Georgia", "Arizona", "North Carolina", "Michigan",
    "Pennsylvania", "Ohio", "Oregon",
    "Alabama", "Alaska", "Arkansas", "Connecticut", "Delaware", "Hawaii", "Idaho", "Indiana", "Iowa",
    "Kansas", "Kentucky", "Maine", "Maryland", "Minnesota", "Mississippi", "Missouri", "Montana",
    "Nebraska", "New Hampshire", "New Jersey", "New Mexico", "North Dakota", "Oklahoma",
