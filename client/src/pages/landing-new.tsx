      ...
      <div className="py-12 sm:py-16 bg-white dark:sm:bg-gray-800 dark:bg-gray-400">
        <div className="max-w-full mx-auto px-4">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white lg:text-4xl break-words hyphens-auto" style={{fontFamily: '"Open Sans", sans-serif', fontWeight: '700'}}>
              Connecting Travelers and Locals Worldwide
            </h2>
            <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto px-2 break-words">
              Join thousands creating authentic connections and unforgettable experiences
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 max-w-7xl mx-auto">
            {/* Card 1: Step-by-step process */}
            <div className="bg-white dark:bg-gray-700 rounded-2xl shadow-lg p-6 sm:p-8 text-center hover:shadow-xl transition-all duration-300 min-w-0 overflow-hidden">
              <div className="mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3 break-words overflow-wrap-anywhere">Join the Community</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed break-words overflow-wrap-anywhere min-w-0">
              ...
              <Button 
                onClick={() => setLocation('/join')}
                className="w-full bg-gradient-to-r from-blue-500 to-orange-500 hover:from-blue-600 hover:to-orange-600 text-white font-bold py-3 px-6 rounded-xl transition-all duration-200 text-sm break-words overflow-wrap-anywhere"
              >
                <span className="break-words overflow-wrap-anywhere">Join the Community</span>
              </Button>
            </div>
            ...
            <div className="bg-white dark:bg-gray-700 rounded-2xl shadow-lg p-6 sm:p-8 text-center hover:shadow-xl transition-all duration-300 min-w-0 overflow-hidden">
              <div className="mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3 break-words overflow-wrap-anywhere">Meet & Connect</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed break-words overflow-wrap-anywhere min-w-0">
                  Browse local events, create meetups, or join existing plans. Chat with people who share your interests and energy for authentic experiences.
                </p>
              </div>
              <Button 
                onClick={() => setLocation('/join')}
                className="w-full bg-gradient-to-r from-blue-500 to-orange-500 hover:from-blue-600 hover:to-orange-600 text-white font-bold py-3 px-6 rounded-xl transition-all duration-200 text-sm break-words overflow-wrap-anywhere"
              >
                <span className="break-words overflow-wrap-anywhere">Start Connecting</span>
              </Button>
            </div>

            {/* Card 3: Real experiences */}
            <div className="bg-white dark:bg-gray-700 rounded-2xl shadow-lg p-6 sm:p-8 text-center hover:shadow-xl transition-all duration-300 min-w-0 overflow-hidden">
              <div className="mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3 break-words overflow-wrap-anywhere">Real Experiences</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed break-words overflow-wrap-anywhere min-w-0">
                  Experience authentic adventures with your new connections. Build lasting friendships through shared experiences, not tourist traps.
                </p>
              </div>
              <Button 
                onClick={() => setLocation('/join')}
                className="w-full bg-gradient-to-r from-blue-500 to-orange-500 hover:from-blue-600 hover:to-orange-600 text-white font-bold py-3 px-6 rounded-xl transition-all duration-200 text-sm break-words overflow-wrap-anywhere"
              >
                <span className="break-words overflow-wrap-anywhere">Start Exploring</span>
              </Button>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <Button
              onClick={() => setLocation('/join')}
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-orange-500 hover:from-blue-700 hover:to-orange-600 text-white font-black text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-6 rounded-2xl shadow-xl transition-all duration-200 border-2 border-white break-words hyphens-auto"
              style={{
            ...
            >
              <span className="break-words leading-tight">JOIN NEARBY TRAVELER TODAY</span>
            </Button>
          </div>
        </div>
      </div>
