        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-blue-500 dark:bg-blue-600 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 text-sm">Walking tours, food tours, cultural experiences</p>
            </div>
            <div className="bg-green-500 dark:bg-green-600 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 text-sm">Hiking, biking, water sports, adventure activities</p>
            </div>
            <div className="bg-orange-500 dark:bg-orange-600 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 text-sm">Hidden gems seeking authentic food lovers</p>
            </div>
            <div className="bg-purple-500 dark:bg-purple-600 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 text-sm">Art classes, cooking lessons, craft workshops</p>
            </div>
            <div className="bg-teal-500 dark:bg-teal-600 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 text-sm">Local guides, drivers, unique transport</p>
            </div>
            <div className="bg-pink-500 dark:bg-pink-600 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 text-sm">Photography tours, city experts, neighborhood specialists</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-emerald-500 dark:bg-emerald-600 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 text-sm">No commission fees like TripAdvisor or Viator. What you earn is yours.</p>
            </div>
            <div className="bg-blue-500 dark:bg-blue-600 p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">📱</div>
              <h3 className="text-xl font-bold mb-3 text-gray-900">Direct Relationships</h3>
              <p className="text-gray-800 text-sm">Build lasting customer relationships without middlemen taking a cut.</p>
            </div>
            <div className="bg-purple-500 dark:bg-purple-600 p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">🔄</div>
              <h3 className="text-xl font-bold mb-3 text-gray-900">Recurring Customers</h3>
              <p className="text-gray-800 text-sm">Travelers return and bring friends. Build a loyal following.</p>
            </div>
            <div className="bg-orange-500 dark:bg-orange-600 p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">📊</div>
              <h3 className="text-xl font-bold mb-3 text-gray-900">Real Customer Insights</h3>
              <p className="text-gray-800 text-sm">Understand what travelers want before they arrive in your city.</p>
            </div>
            <div className="bg-yellow-500 dark:bg-yellow-600 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-800 text-sm">Get alerted when travelers matching your services are planning trips.</p>
            </div>
          </div>
        </div>
      </section>
