            ...
            <div className="grid gap-6 md:gap-8 lg:gap-12 lg:grid-cols-2 items-center">
              ...
              <div className="order-2 lg:order-1 text-center lg:text-left">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-6 sm:mb-8">
                  <span className="landing-gradient-text text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-orange-500">Turn Travelers Into Customers</span>
                </h1>
      ...
      <section className="bg-white dark:bg-gray-900 py-6 sm:py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-[#1e2139] rounded-xl p-6 text-center border-2 border-gray-200 dark:border-white/20 shadow-sm flex flex-col items-center">
