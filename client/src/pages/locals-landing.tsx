    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      <main className="flex-1 px-4 py-16">
        ...
        <div className="max-w-6xl mx-auto text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-white sm:text-gray-700 sm:dark:text-gray-300">Showcase your neighborhood's hidden gems, secret spots, and authentic experiences that only locals know about.</p>
            </div>
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/30 dark:to-orange-800/30 p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Meet Global AND Local Friends</h3>
              <p className="text-white sm:text-gray-700 sm:dark:text-gray-300">Connect with other locals AND travelers from around the world and build lasting friendships right in your hometown.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-white sm:text-gray-700 sm:dark:text-gray-300">Organize meetups, cultural exchanges, and local experiences that bring your community together.</p>
            </div>
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/30 dark:to-pink-800/30 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-white sm:text-gray-700 sm:dark:text-gray-300">Learn about different cultures while sharing yours, creating meaningful cross-cultural connections.</p>
            </div>
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 dark:from-teal-900/30 dark:to-teal-800/30 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-white sm:text-gray-700 sm:dark:text-gray-300">Earn aura points and get references from travelers and locals to create a trusted community.</p>
            </div>
            <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 p-6 rounded-xl shadow-lg">
              ...
              <p className="text-white sm:text-gray-700 sm:dark:text-gray-300">Our AI matches you with locals and travelers based on shared interests, travel dates, and compatibility.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-12 text-gray-900 dark:text-white" style={{fontFamily: '"Open Sans", sans-serif', fontWeight: '700', WebkitTextStroke: '1px black', textShadow: '1px 1px 0px black, -1px -1px 0px black, 1px -1px 0px black, -1px 1px 0px black'}}>
            How It Works for Locals
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-700 dark:text-gray-300">Sign up as a local and showcase your city knowledge, your interests, activities and events you love to do at home and start matching with like-minded others nearby.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-700 dark:text-gray-300">Meet travelers visiting your city and host events, meetups, or experiences for those travelers and other locals who share the same interests and social desires.</p>
            </div>
            <div className="text-center">
              <div className="bg-green-100 dark:bg-green-900/30 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold text-green-600 dark:text-green-400">3</span>
              </div>
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Connect & Grow</h3>
              <p className="text-gray-700 dark:text-gray-300">Create lasting friendships and meaningful connections by sharing your favorite activities with fellow locals and travelers.</p>
            </div>
          </div>
        </div>
        
        {/* Final CTA Section */}
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-orange-600 sm:from-blue-600 sm:to-orange-600 dark:from-blue-400 dark:to-orange-400 dark:sm:from-blue-600 dark:sm:to-orange-600 text-white p-12 rounded-2xl shadow-2xl max-w-5xl mx-auto">
          <div className="text-center">
