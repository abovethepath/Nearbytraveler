          ...
          <div className="max-w-6xl mx-auto px-4 text-center mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch">
              ...
              <div className="bg-purple-500 dark:bg-purple-600 p-6 rounded-xl shadow-lg flex flex-col h-full">
                <div className="text-4xl mb-4">🎯</div>
                <h3 className="text-lg sm:text-xl font-bold mb-4 text-white leading-tight">Interest-Based Matching</h3>
                <p className="text-white/90 text-sm leading-relaxed flex-grow">
              ...
              <div className="bg-blue-500 dark:bg-blue-600 p-6 rounded-xl shadow-lg flex flex-col h-full">
                <div className="text-4xl mb-4">📅</div>
                <h3 className="text-lg sm:text-xl font-bold mb-4 text-white leading-tight">Stay Connected Globally</h3>
                <p className="text-white/90 text-sm leading-relaxed flex-grow">
              ...
              <div className="bg-yellow-500 dark:bg-yellow-600 p-6 rounded-xl shadow-lg flex flex-col h-full">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-4 text-white leading-tight">Weekly Sponsored Events</h3>
                <p className="text-white/90 text-sm leading-relaxed flex-grow">
