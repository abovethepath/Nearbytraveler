...
export default function AmbassadorProgram() {
  ...
  const pointActions = [
    ...
    { action: "Complete an Available Now — I'm Out", points: "+10 pts", description: "Max 1/day, 3/week" },
    { action: "Complete an Available Now — I'm Free", points: "+5 pts", description: "Max 1/day, 3/week" },
