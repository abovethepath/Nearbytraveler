            ...
            <div className="grid gap-6 md:gap-8 lg:gap-12 lg:grid-cols-2 items-center">
              ...
              <div className="order-2 lg:order-1 text-center lg:text-left">
                ...
                <p className="text-base sm:text-lg text-gray-600 dark:text-gray-200 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  Nearby Traveler connects travelers and locals through shared interests, activities, and events and reconnects you when your friends are nearby— making it easy to meet people and build friendships that last a lifetime.
                </p>
