...
export default function WelcomeBusiness() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-orange-100 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800 ${isIOS ? 'pb-24' : ''}`}>
