...
export default function ExternalEventDetails() {
  ...
  const getSourceBadgeColor = (source: string) => {
    switch (source) {
      case 'predicthq': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300';
      case 'allevents': return 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300';
      case 'eventbrite': return 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300';
