  ...
  const steps = [
    {
      ...
      details: [
        ...
        "Add **as many** of your own location-specific interests and activities in **City Plans**",
        "Upload a profile photo to increase connections",
        "Add your hometown and all your **secret non-touristy** events"
      ],
      tip: "The more details you add, the better connections you'll make and definitely add your own non-touristy local adventures for travelers to discover! **TAKE ADVANTAGE OF CITY PLANS!!!!!**"
    },
    {
      number: 2,
