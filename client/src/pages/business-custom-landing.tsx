      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-8 pb-12 bg-white dark:bg-gray-900">
          <div className="mx-auto max-w-6xl px-6 py-8 grid gap-8 md:grid-cols-2 items-center">
            {/* Left text side */}
            <div>
              <div className="mb-4 inline-block rounded-full bg-blue-50 dark:bg-blue-900/30 px-4 py-1 text-sm font-medium text-blue-700 dark:text-blue-400">
              ...
              <p className="mt-2 text-lg italic text-blue-600">
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="text-center mt-16">
              <Button 
                ...
                size="lg"
                className="bg-black hover:bg-gray-800 dark:bg-gradient-to-r dark:from-blue-600 dark:to-purple-600 dark:hover:from-blue-700 dark:hover:to-purple-700 text-white font-black text-xl px-12 py-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                Join Now
              </Button>
