          ...
          <TabsContent value="live" className="space-y-4">
            ...
            {loadingShares ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 font-medium">No one's live in {userCity} right now</p>
                <p className="text-gray-400 dark:text-gray-500 text-sm">Be the first to share where you are!</p>
              </div>
            ) : (
              <div className="space-y-3">
