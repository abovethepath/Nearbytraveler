          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {sortedCities.filter(city => city.city !== 'Los Angeles Metro').map((city, index) => (
              <Card
                ...
                onClick={() => setLocation(`/city/${encodeURIComponent(city.city)}`)}
              >
                <div className="relative h-36 sm:h-48 lg:h-56 overflow-hidden rounded-t-2xl">
                ...
                <CardContent className="p-3 sm:p-5">
                  <h3 className="font-bold text-base sm:text-xl text-gray-900 dark:text-white mb-1 sm:mb-2">
                    {city.city}
                  </h3>
