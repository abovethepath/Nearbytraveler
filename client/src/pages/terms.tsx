...
export default function Terms() {
  ...
  const handleBack = () => {
    // If user has history (e.g. came from signup/auth), go back
    if (window.history.length > 1) {
      window.history.back();
    } else {
      // No history (opened directly) - go to auth/signup
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">3. Eligibility</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">4. Community Standards and User Conduct</h2>
              ...
              <div className="mb-6">
                <h3 className="text-xl font-medium text-gray-800 dark:text-gray-200 mb-3">The NearbyTraveler Pledge</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">By using our platform, you agree to:</p>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-medium text-gray-800 dark:text-gray-200 mb-4">Expected Behavior</h3>
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 dark:text-gray-200 mb-4">Prohibited Conduct</h3>
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 dark:text-gray-200 mb-4">Content Standards</h3>
                  <p className="text-gray-700 dark:text-gray-300 mb-3">All content shared on Nearby Traveler must be appropriate and respectful. Prohibited content includes:</p>
                ...
                <div>
                  <h3 className="text-xl font-medium text-gray-800 dark:text-gray-200 mb-4">Enforcement</h3>
                  <p className="text-gray-700 dark:text-gray-300 mb-3">Violations of these standards may result in:</p>
                  <ul className="list-disc pl-6 space-y-1 text-gray-700 dark:text-gray-300 text-sm">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">5. Business Partnerships and Local Service Connections</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">6. Content and Intellectual Property</h2>
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mt-4">
                  <h4 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">Protected Technologies Include:</h4>
                  <ul className="list-disc pl-4 text-blue-800 dark:text-blue-200 text-sm space-y-1">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">7. Privacy and Data Protection</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">8. Safety and Security</h2>
              <div className="space-y-6 text-gray-700 dark:text-gray-300">
                <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  <p className="text-yellow-800 dark:text-yellow-200 font-semibold mb-2">Your safety is important. Take it seriously. We do.</p>
                  <p className="text-yellow-700 dark:text-yellow-300 text-sm">Meeting people online carries inherent risks. Always prioritize your safety when meeting users in person.</p>
                </div>

                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Review Profiles and References Carefully</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Trust Your Instincts</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Have a Backup Plan</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Be Informed About Local Culture</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Keep All Communications on Nearby Traveler</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Know Your Limits</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Leave References</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Report Negative Experiences</h4>
                ...
                <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4 mt-6">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">9. Disclaimers and Limitations</h2>
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">11. Indemnification</h2>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <section>
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-md mt-3">
                <p className="font-medium text-gray-900 dark:text-gray-100">Nearby Traveler, Inc</p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <button onClick={handleBack} className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors">
              ← Back
            </button>
          </div>
        </div>
