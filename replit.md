...
- **Metro Consolidation Disabled (Aug 2025)**: Per user request, completely disabled automatic metro city consolidations (no more "Los Angeles Metro" chatrooms). Only user-created chatrooms allowed - system returns original city names without consolidation.
