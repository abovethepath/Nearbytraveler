...
- **Simplified Sign-up Process (Aug 2025)**: Major overhaul to streamline onboarding by moving profile completion to after authentication. **Local Travelers**: Keep only date of birth, 3 top choices minimum (max removed), and hometown location. **Traveling Users**: Keep only date of birth and 3 top choices minimum. **Removed from both**: Gender, sexual preference, bio, interests beyond top choices, activities, events, languages, veteran/active duty status. All removed fields moved to in-app profile completion. Enhanced welcome page guides new members to complete profile and discover City Match features.
