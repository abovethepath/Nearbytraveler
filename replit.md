...
CATEGORY NAMING STANDARDS: "Nightlife & Parties" is the official name (not "Nightlife & Dancing" or "Nightlife & Drinks"). "Comedy Clubs" removed from nightlife sub-interests (keep "Comedy Shows" only). EVENT_CATEGORIES removed "Education & Learning" and "Business & Professional"; added "Outdoor & Nature" and "Tours & Experiences". AI Event Draft imports official EVENT_CATEGORIES from shared/eventCategories.ts (no local duplicates).
