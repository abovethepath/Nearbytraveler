...
function buildUserData(api: RandomUser): PreparedUser {
  ...
  return {
    ...
    // NOTE: no age/gender validation here — face-api.js + tfjs were too
    // heavy for the app build. Run scripts/fix-seed-photos.ts manually to
    // clean up bad faces after seeding.
