...
//
// NOTE: this script does NOT validate age or gender. face-api.js + tfjs were
// too heavy for the app build. For adult + gender-match filtering, run
// scripts/fix-seed-photos.ts separately on Render shell after installing
// the face-api deps with `npm install --no-save`.
//
// CLI
// ───
