...
export const US_CITIES_BY_STATE: Record<string, string[]> = {
  ...
  "California": ["Los Angeles", "San Francisco", "San Diego", "Sacramento", "San Jose", "Oakland", "Fresno", "Long Beach", "Santa Ana", "Riverside", "Stockton", "Irvine", "Fremont", "San Bernardino", "Modesto", "Fontana", "Oxnard", "Moreno Valley", "Huntington Beach", "Glendale", "Santa Clarita", "Garden Grove", "Santa Rosa", "Oceanside", "Rancho Cucamonga", "Ontario", "Lancaster", "Elk Grove", "Corona", "Palmdale", "Salinas", "Pomona", "Hayward", "Escondido", "Torrance", "Sunnyvale", "Orange", "Fullerton", "Pasadena", "Thousand Oaks", "Visalia", "Simi Valley", "Concord", "Roseville", "Santa Clara", "Vallejo", "Victorville", "El Monte", "Berkeley", "Downey", "Costa Mesa", "Inglewood", "Buena Park", "Alhambra", "West Covina", "Whittier", "Compton", "Hawthorne", "Carson", "Lakewood", "Bellflower", "Norwalk", "Cerritos", "La Mirada", "Diamond Bar", "Walnut", "Azusa", "Glendora", "Covina", "Claremont", "Upland", "Redlands", "Chino", "Chino Hills", "La Verne", "Monrovia", "Arcadia", "Temple City", "Monterey Park", "Rosemead", "West Hollywood", "Culver City", "Santa Monica", "Venice", "Manhattan Beach", "Hermosa Beach", "Redondo Beach", "Palos Verdes", "San Dimas", "La Habra", "Brea", "Yorba Linda", "Placentia", "Cypress", "Stanton", "Westminster", "Fountain Valley", "Laguna Beach", "Dana Point", "San Clemente", "Mission Viejo", "Lake Forest", "Rancho Santa Margarita", "Aliso Viejo", "Laguna Niguel", "Tustin", "Newport Beach",
    "Silver Lake", "Echo Park", "Highland Park", "Koreatown", "Leimert Park", "Crenshaw", "El Segundo", "Marina del Rey", "Playa Vista", "Playa del Rey", "Westchester", "Ladera Heights",
    "Anaheim", "Seal Beach", "Los Alamitos", "Laguna Hills", "La Palma",
    "Villa Park", "Rossmoor", "Midway City", "Sunset Beach", "Surfside", "Coto de Caza", "Las Flores", "Ladera Ranch", "Trabuco Canyon", "Portola Hills", "Foothill Ranch"],
  ...
  "New York": ["Manhattan", "Brooklyn", "Queens", "Bronx", "Staten Island", "Buffalo", "Rochester", "Yonkers", "Syracuse", "Albany", "Schenectady",
    "Astoria", "Long Island City", "Flushing", "Jamaica", "Forest Hills", "Rego Park", "Jackson Heights", "Elmhurst", "Corona", "Woodside", "Sunnyside", "Ridgewood", "Glendale", "Middle Village", "Maspeth", "Bayside", "Whitestone", "College Point", "Fresh Meadows", "Hollis", "Springfield Gardens", "Rosedale", "Far Rockaway", "Rockaway Beach",
    "Williamsburg", "DUMBO", "Park Slope", "Crown Heights", "Bushwick", "Bed-Stuy", "Flatbush", "Bay Ridge", "Bensonhurst", "Coney Island", "Brighton Beach", "Greenpoint", "Cobble Hill", "Carroll Gardens", "Boerum Hill", "Fort Greene", "Clinton Hill", "Prospect Heights", "Sunset Park", "Borough Park", "Flatlands", "Canarsie", "East New York", "Brownsville", "Sheepshead Bay",
    "Harlem", "East Harlem", "Washington Heights", "Inwood", "Upper West Side", "Upper East Side", "Midtown", "Hell's Kitchen", "Chelsea", "Greenwich Village", "West Village", "SoHo", "Tribeca", "Financial District", "Lower East Side", "East Village",
    "Riverdale", "Fordham", "Pelham Bay", "Co-op City", "Mott Haven", "South Bronx", "Throgs Neck",
    "St. George", "Stapleton", "New Dorp"],
...
export const COUNTRIES = [
  // Top travel destinations (kept at top for quick access)
  "United States",
  "United Kingdom",
  "Canada",
  "Mexico",
  ...
  "Turkey",
  "Indonesia",
  // All countries & territories alphabetically
  "Abkhazia",
  "Afghanistan",
  "Albania",
  "Algeria",
