import { pgTable, text, serial, integer, boolean, timestamp, real, varchar, jsonb, unique, decimal, index, date } from "drizzle-orm/pg-core";
...
export const users = pgTable("users", {
    ...
    subInterests: text("sub_interests").array(), // Sub-interests for detailed matching
...
export const cityGuides = pgTable("city_guides", {
    ...
    localTips: jsonb("local_tips").$type(),
    hiddenGems: jsonb("hidden_gems").$type(),
    foodRecommendations: jsonb("food_recommendations").$type(),
    safetyTips: jsonb("safety_tips").$type(),
    specificEvents: jsonb("specific_events").$type(),
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at").defaultNow(),
});
