...
export const PRIVATE_INTERESTS_BY_CATEGORY: Record<string, string[]> = {
  "Lifestyle & Relationships": [
    "Nudist / Naturist",
    "ENM / Ethical Non-Monogamy",
    "Swinger Lifestyle",
    "Hotwife / Lifestyle Couple",
    "Single in the Lifestyle",
    "Unicorn Friendly",
    "BDSM / Kink",
  ...
  "Lifestyle Travel": [
    ...
    "Hedonism / Desire Resorts",
    "Lifestyle Travel Events",
    "Nudist Resorts & Camps",
    "Adults-Only Cruises",
    "Sex-Positive Retreats",
    "Lifestyle Parties Abroad",
  ],
  "Spiritual & Sensual": [
    "Tantra",
    "Breathwork & Intimacy",
  ...
  "Vibe": [
    ...
    "Playful Energy",
    "Deep Conversations",
    "Intimacy Over Small Talk",
  ],
};

export const PRIVATE_INTERESTS: string[] = Object.values(PRIVATE_INTERESTS_BY_CATEGORY).flat();

export function getPrivateInterests(): string[] {
