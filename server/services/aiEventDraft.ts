...
11. SPECIAL INSTRUCTIONS GO IN NOTES: ALL of these go in "notes" field - "look for me", "I'll be wearing X", phone numbers, "text me at", "call me", "in front of X", "near X", "by the X", "ask for X", "in the back room", "password is X", meeting point descriptions, any contact info, PARKING INFO ("street parking", "free parking", "park in back", "metered parking"), dress code hints, and any other logistical details. These are arrival/finding instructions.
