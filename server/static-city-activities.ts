...
export const FEATURED_CITY_ACTIVITIES: Record<string, Array<{name: string, description: string, category: string, rank: number}>> = {
  ...
  "Los Angeles": [
    ...
    { name: "Hollywood Walk of Fame & TCL Chinese Theatre", description: "Celebrity stars and handprints at the historic movie palace", category: "landmarks", rank: 3 },
    { name: "Santa Monica Pier", description: "Classic amusement park on the Pacific with Ferris wheel", category: "entertainment", rank: 4 },
    { name: "Venice Beach", description: "Bohemian beach with street performers, muscle beach, and boardwalk", category: "beach", rank: 5 },
    { name: "The Getty Center", description: "World-class art museum with architecture and stunning city views", category: "culture", rank: 6 },
    { name: "The Broad Museum", description: "Contemporary art museum with Yayoi Kusama infinity rooms", category: "culture", rank: 7 },
    { name: "LACMA & La Brea Tar Pits", description: "Iconic art museum and active paleontological site", category: "culture", rank: 8 },
    { name: "Universal Studios Hollywood", description: "Movie studio tours and thrilling theme park rides", category: "theme_park", rank: 9 },
    { name: "Grand Central Market", description: "Historic food hall with diverse vendors and cuisines", category: "food", rank: 10 },
    { name: "Rodeo Drive", description: "World-famous luxury shopping street in Beverly Hills", category: "shopping", rank: 11 },
    { name: "Malibu Beaches", description: "Scenic coastal drive with pristine beaches and celebrity homes", category: "beach", rank: 12 },
  ],
  "San Francisco": [
